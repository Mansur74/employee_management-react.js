              ...
              <ul className="navbar-nav ms-auto">
                <li className="nav-item dropdown">
                  <a className="nav-link" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    <img src={user?.userDetail?.imgURL ? user?.userDetail?.imgURL : "https://bootdey.com/img/Content/avatar/avatar1.png"} className="rounded-circle avatar-sm img-thumbnail object-fit-cover" alt="profile-image" />
                  </a>
